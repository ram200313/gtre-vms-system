...
for file_path in html_files:
    ...
    if filename in ["index.html", "admin_login.html"]:
        continue
    ...
    if sidebar_match:
        ...
        new_sidebar = f'''<nav class="sidebar-nav">
                ...
                <a href="visitor_request.html" class="nav-item{act_pre_reg}">
...
old_reg_file = os.path.join(frontend_dir, "officer_registration.html")
if os.path.exists(old_reg_file):
    os.remove(old_reg_file)
    print("Deleted officer_registration.html")
